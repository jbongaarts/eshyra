...
export function buildSystemPrompt(
  ...
  return [
    ...
    '  `give_item`/`claim_item`/`adopt_item`/`use_item`/`transfer_item`/`remove_item` for inventory, `update_clock` for time and',
