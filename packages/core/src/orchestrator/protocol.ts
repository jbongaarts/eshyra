...
export function buildSystemPrompt(
  ...
  return [
    ...
    '  improvised lore. Prose that claims a state change without a tool call',
    '  does NOT change the game — always call the tool.',
    ...
    '  gestures, mundane props, and non-recurring background detail. Do not',
    '  promote every flourish. Examples not to promote: a chipped cup, damp',
    '  wool smell, rough wool clothing.',
