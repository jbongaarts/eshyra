...
export function buildSystemPrompt(
  ...
  return [
    ...
    '  when the spend casts a spell, pass spell:{cantrip} so the',
    '  bonus-action-spell timing rule is enforced. After adjudicating',
    ...
    '- Roll visibility metadata: when you call `roll`, decide and include',
    '  `visibility` and `category`. Use visibility:"player_visible" for rolls',
