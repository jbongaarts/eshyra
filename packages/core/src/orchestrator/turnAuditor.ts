...
const AUDIT_POLICY = [
  ...
  '  `give_item`, `claim_item`, `adopt_item`, `use_item`, `transfer_item`, `remove_item`, `update_clock`, `set_plot_flag`, `set_world_fact`).',
  ...
  '  `claim_item`, `adopt_item`, `use_item`, `transfer_item`, `remove_item`) to answer such a query is a violation: list that tool in',
