...
> = new Map(
  (
    [
      ...
      [
        'feature',
        'options[].effect.requiredProperties[]',
        ['two-handed', 'versatile'],
      ],
      ['feature', 'options[].effect.target', ['other-creature']],
...
const FOUNDATION1_EXECUTED_FIELDS = new Set([
  ...
  'feature|data.mechanics.procedures[].options[].effect.requiredProperties[]',
  'feature|data.mechanics.procedures[].options[].effect.target',
